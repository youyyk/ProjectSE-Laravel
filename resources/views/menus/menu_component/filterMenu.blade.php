<span class="mb-3 float-end">
            <form class="form-inline" >
                <span class="float-start ">filter :</span>
                <span class="float-start px-2">
{{--                <span class="col-1 ">filter : </span>--}}
                {{-- filter by category --}}
                <select class="form-select form-select-sm text-center bg rounded-1" name="selected_cat" id="selected_cat">
...
{{--                <span class="col-sm-1">--}}
                ...
                <select class="form-select form-select-sm text-center bg rounded-1" name="selected_depart" id="selected_depart">
                ...
                {{-- search by name --}}
                <span class="float-start px-2">
                <input type="text" class="rounded-2 text-center form-control form-control-sm" name="search" id="search" autocomplete="off" placeholder="ชื่อเมนู" value="{{$filterMenu['search_name']}}">
                </span>
                @if($user_role=='admin')
