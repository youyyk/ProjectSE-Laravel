<div class="modal fade" id="deleteTableModal{{$resTable->id}}" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center m-3">
                <h5 class="mb-4">คุณต้องการลบ <b>{{$resTable->name}}</b> ใช่หรือไม่?</h5>
